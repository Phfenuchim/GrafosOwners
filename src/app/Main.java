...
public class Main {
    public static void main(String[] args)  {
        ...
        GrafoBrasil<String> grafo = new GrafoBrasil<String>();
        {
        ...
        while (continuar) {
            System.out.println("\n--- Menu de Operações ---");
            System.out.println("1. Listar Capitais");
            System.out.println("2. Listar caminhos possíveis");//Busca por largura
            System.out.println("3. Listar caminho ");//Busca pela profundidade
            System.out.println("4. Listar caminho com menor distância");//busca por dijkstra
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    String cidadePartida = scan.next();
                    grafo.caminhosPossiveis(cidadePartida);
                    break;
                case 3:
                    System.out.print("Digite o ID da cidade de partida: ");
                    String partidaDist = scan.next();
                    System.out.print("Digite o ID da cidade de destino: ");
                    String destinoDist = scan.next();
                    grafo.buscaProfundidade(partidaDist,destinoDist);
                    break;
                case 4:
                    System.out.print("Digite o ID da cidade de partida: ");
                    String partidaTempo = scan.next();
                    System.out.print("Digite o ID da cidade de destino: ");
                    String destinoTempo = scan.next();
                    grafo.menorTempo(partidaTempo,destinoTempo);
                    break;
                case 5:
                    continuar = false;
